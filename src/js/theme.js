const dark = () => {
  ...
  document.querySelector("#p-header").setAttribute("class", "text-white fs-5 mx-5 mx-md-0");
...
const light = () => {
  ...
  document.querySelector("#p-header").setAttribute("class", "text-black fs-5 mx-5 mx-md-0");
